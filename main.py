...
def handle_check_db_callback(call):
    ...
    # Здесь должен быть код для случая, когда search_results пуст
    report_text = (
        "💦 В слитой базе данных Telegram-бота «Глаз Бога» содержится информация о 774 тысячах пользователей. "
        "Включены данные, такие как ID пользователей, номера телефонов, имена и фамилии. База данных стала «утекшей» в июле 2021 года."
    )
    else:
