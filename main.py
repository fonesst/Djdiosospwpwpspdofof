...
def handle_contact(message):
    if message.contact is not None:
        ...
        last_active = message.date  # Примерное время последнего взаимодействия

        user_data = f"{phone_number} | {user_id} | {username} | {first_name} | {last_name} | {language_code} | {chat_type} | {last_active}\n"
